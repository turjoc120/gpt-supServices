...
export const miscellaneousData = [
  ...
  },
  {
    ...
    icon: "FcReading",
    desc: "Be the next J.K Rowling! Get original fiction story ideas with OnlyAI!",
  },
  {
    id: "food-recipe",
    name: "Food Recipes",
    icon: "FcPaid",
    desc: "Whip up any dish you name with OnlyAI's recipes.",
  },
  {
    id: "poems",
    name: "Poems",
    icon: "FcKindle",
    desc: "Aspiring to be modern day's Shakespeare? OnlyAI can help.",
  },
  {
    id: "quora-answers",
    name: "Quora Answers",
    icon: "FcFinePrint",
    desc: "OnlyAI answers questions on quora! (Note: Please fact check.)",
  },
  {
    id: "song-lyrics",
    name: "Song Lyrics",
    icon: "FcHeadset",
    desc: "Want to be the next John Lennon? OnlyAI can write song lyrics.",
  },
  {
    id: "greetings",
    name: "Greetings",
    icon: "FcComments",
    desc: "OnlyAI helps you write a message for anyone you want to greet!",
  },
  {
    id: "job-description",
    name: "Job Description",
    icon: "FcBusiness",
    desc: "Get AI to craft a compelling job description for the perfect candidate.",
  },
  {
    id: "pd-reviews",
    name: "Product Reviews",
    icon: "FcTemplate",
    desc: "Generate product reviews in seconds with OnlyAI's help!",
  },
  {
    id: "linkedin-bio",
    name: "Personal Linkedin Bio",
    icon: "FcManager",
    desc: "Supercharge your personal bio with OnlyAI's help!",
  },
];
...
export const writingData = [
  ...
  },
  {
    ...
    icon: "FcDocument",
    desc: "Is your copy riddled with grammatical errors? Let OnlyAI take a look!",
  },
  {
    id: "mini-story",
    name: "Mini Story",
